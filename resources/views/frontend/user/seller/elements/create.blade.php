            ...
            <div class="d-flex align-items-start">
                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="mx-auto col-lg-12">
                        <form class="form form-horizontal mar-top" action="{{ route('seller.elements.store') }}"
                                    ...
                                    <div class="form-group row" id="category">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control aiz-selectpicker" name="category_id"
                                                id="category_id" data-selected="" data-live-search="true" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control aiz-selectpicker" data-live-search="true"
                                                data-selected-text-format="count" name="selected_attribute_ids[]"
                                                id="selected_attribute_id" multiple>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control aiz-selectpicker" data-live-search="true"
                                                data-selected-text-format="count" name="selected_variations[]"
                                                id="selected_variations" multiple>
                                                {{-- <option value="" disabled>{{translate('Select Attribute')}}</option> --}}
                                                {{-- @foreach (\App\Color::orderBy('name', 'asc')->get() as $key => $color)
                                    <option value="" data-content="<span><span class='mr-2 border rounded size-15px d-inline-block' style='background:{{ $color->code }}'></span><span>{{ $color->name }}</span></span>"></option>
                                @endforeach --}}
                                    ...
                                    <div class="d-block">
                                        <button type="button" class="mb-3 btn btn-info"
                                            onclick="update_attribute_combination()">{{ translate('Generate variations') }}</button>
                                    </div>
                            ...
                            <div class="mb-3 text-right">
                                <button type="submit" name="button"
                                    class="btn btn-info">{{ translate('Save Element') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
