                        ...
                        <div class="card-body">
                            <form action="{{ route('customer.profile.update') }}" method="POST"
                                ...
                                <div class="form-group mb-0 text-right">
                                    <button type="submit"
                                        class="btn btn-primary">{{ translate('Update Profile') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                            <div>
                                                ...
                                                <span
                                                    class="ml-2">{{ $address->address ?? 'empty field' }}</span>
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                <span class="w-50 fw-600">{{ translate('Region') }}:</span>
                                                <span class="ml-2">
...
@endsection
{{-- TODO::madalni tog'irlash kere country ni --}}
