<div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
    ...
    <div class="absolute-top-right d-xl-none">
        <button class="p-2 btn btn-sm" data-toggle="class-toggle" data-target=".aiz-mobile-side-nav"
            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                @if (isDriver())
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('assigned-deliveries') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['assigned-deliveries']) }}">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('pickup-deliveries') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['pickup-deliveries']) }}">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('on-the-way-deliveries') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['on-the-way-deliveries']) }}">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('completed-deliveries') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['completed-deliveries']) }}">
                ...
                @else
                    ...
                    @if (Auth::user()->user_type == 'seller')
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.elements.all') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.elements.all', 'seller.elements.create']) }}">
                                <i class="lab la-sketch aiz-side-nav-icon"></i>
            ...
            <div class="pt-1 pb-3 widget-balance">
                <div class="text-center">
                    <div class="mb-4 heading-4 strong-700">
                        ...
                        @endphp
                        <small
                            class="mb-2 d-block fs-12">{{ translate('Your sold amount (current month)') }}</small>
