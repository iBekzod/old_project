...
{{--                                       data-toggle="modal" data-target="#AttributesModal_{{$branch->id}}"--}}
{{--                                       title="{{ translate('Attributes') }}">--}}
{{--                                        <i class="fa fa-list-alt"></i>--}}
{{--                                    </a>--}}
                                    <form class="p-4" action="{{ route('branches.update', $branch->id) }}"
                                          method="POST">
                                        @csrf
                                        <div class="modal fade" id="EditModal_{{$branch->id}}" tabindex="-1"
                                             role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="exampleModalLabel">{{translate('Branch Information')}}</h5>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" placeholder="{{translate('Name')}}"
                                                                       ...
                                                                       required
                                                                       value="{{ $branch->getTranslation('name') }}">
                                                            </div>
                                                        </div>
                                                    </div>
...
{{--                                    <form action="{{ route('branches.update.arributes', $branch->id) }}" method="POST">--}}
{{--                                        @csrf--}}
{{--                                        <div class="modal fade" id="AttributesModal_{{$branch->id}}" tabindex="-1"--}}
{{--                                             role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">--}}
{{--                                            <div class="modal-dialog modal-dialog-centered" role="document">--}}
{{--                                                <div class="modal-content">--}}
{{--                                                    <div class="modal-header">--}}
{{--                                                        <h5 class="modal-title"--}}
{{--                                                            id="exampleModalLongTitle">{{translate('Attributes')}}--}}
{{--                                                            : {{ $branch->getTranslation('name') }}</h5>--}}
{{--                                                        <button type="button" class="close" data-dismiss="modal"--}}
{{--                                                                aria-label="Close">--}}
{{--                                                            <span aria-hidden="true">&times;</span>--}}
{{--                                                        </button>--}}
...
{{--                                                                        multiple name="attribute_id[]"--}}
{{--                                                                        id="attribute_id">--}}
{{--                                                                    @foreach ($attribute_selections as $key => $attribute)--}}
{{--                                                                        <option value="{{ $attribute->id }}"--}}
{{--                                                                                @if($attribute->branch_id==$branch->id) selected @endif>{{ $attribute->getTranslation('name') }}</option>--}}
{{--                                                                    @endforeach--}}
{{--                                                                </select>--}}
{{--                                                                --}}{{--                                                            </div>--}}
{{--                                                            </div>--}}
