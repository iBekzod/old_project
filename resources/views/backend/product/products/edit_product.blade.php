                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <select class="form-control aiz-selectpicker" name="delivery_type"  onchange="change_selection(this.value, 'delivery_type_change')" >
                                            ...
                                            <option value="tarif" selected>{{ translate('Tarif') }}</option>
                                    ...
                                    <tr class="variant">
                                        ...
                                        <td>
                                            <select class="form-control aiz-selectpicker discount_type_change"
                                                ...
                                                <option value="percent" @if($seller_product->discount_type=='percent') selected @endif selected>{{translate('Percent')}}</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select class="form-control aiz-selectpicker delivery_type_change"
                                                    name="variation[{{ $index }}][delivery_type]">
                                                    <option value="free"  @if($seller_product->delivery_type=='free') selected @endif >{{translate('Free')}}</option>
                                                    <option value="tarif" @if($seller_product->delivery_type=='tarif') selected @endif>{{translate('Tarif')}}</option>
                                                    {{-- <option value="tinfis" selected>{{translate('TINFIS Cargo')}}</option> --}}
                                            </select>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <select class="form-control aiz-selectpicker tax_type_change"
                                                    name="variation[{{ $index }}][tax_type]">
                                                <option value="amount"  @if($seller_product->tax_type=='amount') selected @endif >{{translate('Flat')}}</option>
                                                <option value="percent"   @if($seller_product->tax_type=='percent') selected @endif >{{translate('Percent')}}</option>
                                            </select>
                                        </td>
                                        <td>
                                            <label class="mb-0 aiz-switch aiz-switch-success">
