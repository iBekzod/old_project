        ...
        <form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" id="category">
                        <label class="col-lg-3 col-from-label">{{translate('Product Attributes')}}</label>
                        <div class="col-lg-8">
                            <select class="form-control aiz-selectpicker" multiple name="attrs[]" id="attrs" data-live-search="true" required>
