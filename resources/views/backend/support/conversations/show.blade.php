    ...
    <div class="card">
        <div class="card-header row gutters-5">
            <div class="text-center text-md-left">
                <b> {{ $conversation->sender->name }} </b> #  <span class="ml-2"> {{ $conversation->created_at }} </span>
               <div class="mt-2">
         ...
         {{-- @dd($conversation); --}}
        <div class="card-body">
            <form action="{{ route('conversation.admin_store') }}" method="post" id="conversation-message-form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <textarea class="aiz-text-editor" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' name="message" required></textarea>
                </div>
                ...
                <div class="form-group mb-0 text-right">
                    <button type="submit" class="btn btn-sm btn-dark" onclick="submit_message('pending')">{{ translate('Submit as') }}</strong></button>
                </div>
            </form>
<div class="pad-top">
    <ul class="list-group list-group-flush">
        @foreach($conversation->messages as $conversation_messages)
            @if(auth()->id()==$conversation_messages->user_id)
                <li class="list-group-item" style="float: right;">
                    <div class="media float-right mr-5 mt-4">
            ...
            @else
                <li class="list-group-item">
                    ...
                    <div class="card float-rigth d-block" style="width: 75%;">
                        <div class="card-header">
                           <b> message:</b>
                        </div>
                        <div class="card-body">
        ...
        <li class="list-group-item">
            <div class="media float-left " style="width:20%;">
                <a class="media-left" href="#">
                    @if($conversation_messages->user->avatar_original != null)
