                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link text-reset  active  py-3"
                                                               href="http://cms.asrorztg.beget.tech/admin/product-attributes/43/edit?lang=en">
                                                                <img
                                                                    src="http://cms.asrorztg.beget.tech/public/assets/img/flags/en.png"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3"
                                                               href="http://cms.asrorztg.beget.tech/admin/product-attributes/43/edit?lang=ru">
                                                                <img
                                                                    src="http://cms.asrorztg.beget.tech/public/assets/img/flags/ru.png"
                                                                    height="11" class="mr-1">
                                                                <span>Russian</span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link text-reset  bg-soft-dark border-light border-left-0  py-3"
                                                               href="http://cms.asrorztg.beget.tech/admin/product-attributes/43/edit?lang=uz">
                                                                <img
                                                                    src="http://cms.asrorztg.beget.tech/public/assets/img/flags/uz.png"
                                                                    height="11" class="mr-1">
                                                                <span>Uzbek</span>
                                                            </a>
                                                        </li>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="exampleModalLabel">{{ translate('Change categories') }}</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
