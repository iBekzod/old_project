...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-10 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>{{ translate('Banner & Links') }}</label>
                            <div class="home-banner_horizontal-target">
                                <input type="hidden" name="types[]" value="home_banner_horizontal_images">
                                <input type="hidden" name="types[]" value="home_banner_horizontal_links">
                                @if (get_setting('home_banner_horizontal_images') != null)
                                    @foreach (json_decode(get_setting('home_banner_horizontal_images'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-5">
                                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                    <input type="hidden" name="types[]" value="home_banner_horizontal_images">
                                                    <input type="hidden" name="home_banner_horizontal_images[]" class="selected-files" value="{{ json_decode(get_setting('home_banner_horizontal_images'), true)[$key] }}">
                                                </div>
                                                <div class="file-preview box sm">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_banner_horizontal_links">
                                                    <input type="text" class="form-control" placeholder="http://" name="home_banner_horizontal_links[]" value="{{ json_decode(get_setting('home_banner_horizontal_links'), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
							...
							<div class="row gutters-5">
								<div class="col-5">
									<div class="input-group" data-toggle="aizuploader" data-type="image">
										...
										<div class="form-control file-amount">{{ translate('Choose File') }}</div>
										<input type="hidden" name="types[]" value="home_banner_horizontal_images">
										<input type="hidden" name="home_banner_horizontal_images[]" class="selected-files">
									</div>
									<div class="file-preview box sm">
									</div>
								</div>
								<div class="col">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_banner_horizontal_links">
										<input type="text" class="form-control" placeholder="http://" name="home_banner_horizontal_links[]">
									</div>
								</div>
								<div class="col-auto">
									<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
                                ...
                                data-target=".home-banner_horizontal-target">
                                {{ translate('Add New') }}
                            </button>
                        </div>
                        <div class="text-right">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Home Banner vertical') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>{{ translate('Banner & Links') }}</label>
                            <div class="home-banner_vertical-target">
                                <input type="hidden" name="types[]" value="home_banner_vertical_images">
                                <input type="hidden" name="types[]" value="home_banner_vertical_links">
                                @if (get_setting('home_banner_vertical_images') != null)
                                    @foreach (json_decode(get_setting('home_banner_vertical_images'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-5">
                                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                    <input type="hidden" name="types[]" value="home_banner_vertical_images">
                                                    <input type="hidden" name="home_banner_vertical_images[]" class="selected-files" value="{{ json_decode(get_setting('home_banner_vertical_images'), true)[$key] }}">
                                                </div>
                                                <div class="file-preview box sm">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_banner_vertical_links">
                                                    <input type="text" class="form-control" placeholder="http://" name="home_banner_vertical_links[]" value="{{ json_decode(get_setting('home_banner_vertical_links'), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
							...
							<div class="row gutters-5">
								<div class="col-5">
									<div class="input-group" data-toggle="aizuploader" data-type="image">
										...
										<div class="form-control file-amount">{{ translate('Choose File') }}</div>
										<input type="hidden" name="types[]" value="home_banner_vertical_images">
										<input type="hidden" name="home_banner_vertical_images[]" class="selected-files">
									</div>
									<div class="file-preview box sm">
									</div>
								</div>
								<div class="col">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_banner_vertical_links">
										<input type="text" class="form-control" placeholder="http://" name="home_banner_vertical_links[]">
									</div>
								</div>
								<div class="col-auto">
									<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
                                ...
                                data-target=".home-banner_vertical-target">
                                {{ translate('Add New') }}
                            </button>
                        </div>
                        <div class="text-right">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Home Banner square') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>{{ translate('Banner & Links') }}</label>
                            <div class="home-banner_square-target">
                                <input type="hidden" name="types[]" value="home_banner_square_images">
                                <input type="hidden" name="types[]" value="home_banner_square_links">
                                @if (get_setting('home_banner_square_images') != null)
                                    @foreach (json_decode(get_setting('home_banner_square_images'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-5">
                                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                    <input type="hidden" name="types[]" value="home_banner_square_images">
                                                    <input type="hidden" name="home_banner_square_images[]" class="selected-files" value="{{ json_decode(get_setting('home_banner_square_images'), true)[$key] }}">
                                                </div>
                                                <div class="file-preview box sm">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_banner_square_links">
                                                    <input type="text" class="form-control" placeholder="http://" name="home_banner_square_links[]" value="{{ json_decode(get_setting('home_banner_square_links'), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
							...
							<div class="row gutters-5">
								<div class="col-5">
									<div class="input-group" data-toggle="aizuploader" data-type="image">
										...
										<div class="form-control file-amount">{{ translate('Choose File') }}</div>
										<input type="hidden" name="types[]" value="home_banner_square_images">
										<input type="hidden" name="home_banner_square_images[]" class="selected-files">
									</div>
									<div class="file-preview box sm">
									</div>
								</div>
								<div class="col">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_banner_square_links">
										<input type="text" class="form-control" placeholder="http://" name="home_banner_square_links[]">
									</div>
								</div>
								<div class="col-auto">
									<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
                                ...
                                data-target=".home-banner_square-target">
                                {{ translate('Add New') }}
                            </button>
                        </div>
                        <div class="text-right">
