...
// Route::get('seller/autoidentification/form/ridirect','SellerAutoidentificationFormController@seller_autoidentification_form_save')->name('seller.autoidentification.redirect');
